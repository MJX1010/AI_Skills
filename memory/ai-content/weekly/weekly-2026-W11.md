...
### 6. [Mac 本地安装原生 OpenClaw 补充说明](https://mp.weixin.qq.com/s/yqNRNerMFJefadcl7oe-lA)

Mac 系统很适合当服务器用，养虾最合适。本文补充说明几个关键问题：

1. **安全防护** - 使用 OpenClaw 和 Agent 时一定要注意安全和防护
2. **版本升级** - 使用 `npm i -g openclaw@latest` 升级，最新版本是 v2026.3.11
3. **模型选择** - 推荐使用国产大模型（MiniMax M2.5），更便宜；避免使用 Gemini API（易封号）
4. **MiniMax MCP 工具** - 安装 Coding Plan MCP 实现图片识别和精确搜索能力

> 来源：[微信公众号](https://mp.weixin.qq.com/s/yqNRNerMFJefadcl7oe-lA) · 2026-03-14

### 7. [OpenClaw之父给程序员的建议：保持玩乐心去构建梦寐以求的东西❗️](https://b23.tv/705kx27)

OpenClaw 之父给程序员的建议：**保持玩乐心去构建梦寐以求的东西**。这是一个关于程序员心态和编程哲学的视频，强调在编程过程中保持乐趣和创造力的重要性。

**UP主**: 奇技 | 播放量: 9392 | 点赞: 39
